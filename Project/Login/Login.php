...
<?php 
		include 'navbar.php';
	 ?>
	 <p> <a href="http://localhost/project/Include/">   HomePage </a>'   <a href="http://localhost/project/Login/Login.php">    Login </a>    '<a href="http://localhost/project/JSON/store.php">    Registration </a>     '<a href="http://localhost/project//Teacher's%20Information/load.php">    Teacher's Information </a></p>
